...
int main()
{
	double db_var = 1.0 / 3.0;
	float ft_var = 1.0 / 3.0;
	printf("The double variable: %.4f, %.12f, %.16f.\n", db_var, db_var, db_var);
	printf("The float variable: %.4f, %.12f, %.16f.\n", ft_var, ft_var, ft_var);
	// dispay FLT_DIG, DBL_DIG
	printf("FLT_DIG = %d\n", FLT_DIG);
	printf("DBL_DIG = %d\n", DBL_DIG);
	return 0;
}
