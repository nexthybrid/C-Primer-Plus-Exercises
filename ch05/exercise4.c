...
int main()
{
	printf("Enter a height in centimeters:_____(cm)\b\b\b\b\b\b\b\b\b");
	float height_cm;
	scanf("%f", &height_cm);
	float height_in;
	int feet;
	...
	while (height_cm > 0){
		...
		inches = height_in - (float)feet * 12;
		printf("\n%.1f cm = %u feet, %.1f inches.\n", height_cm, feet, inches);
		printf("Enter a height in centimeters (<=0 to quit):_____(cm)\b\b\b\b\b\b\b\b\b");
		scanf("%f", &height_cm);
	}
	if (height_cm <= 0)
		printf("bye\n");
